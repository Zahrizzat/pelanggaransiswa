...
// end poin akses data siswa
app.get("/siswa", (req, res) => {
    //create sql query
    let sql = "select * from siswa1"
...
// end point akses data siswa bedasarkan id_siswa tertentu
app.get("/siswa/:id", (req,res) => {
    let data = {
        id_siswa: req.params.id
    }
    //create sql query
    let sql = "select * from siswa1 where? "
...
app.post("/siswa", (req,res) => {
        ...
        let sql = "insert into siswa1 set ?"
        // run query
        db.query(sql, data, (error, result) => {
            let response = null
            if (error) {
...
app.put("/siswa", (req,res) => {
        ...
        let sql = "update siswa1 set ? where ? "
        // run query
    db.query(sql, data, (error, result) => {
        let response = null
        if (error) {
...
app.delete("/siswa/:id", (req,res) => {
        ...
        let sql = "delete from siswa1 where ?"
        // run query
        db.query(sql, data, (error, result) => {
            let response = null
            if (error) {
